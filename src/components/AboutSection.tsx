...
export default function AboutSection() {
  return (
    <section id="about" className="w-full py-20 scroll-mt-20" aria-label="About Me">
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center md:items-start gap-12">
        ...
        {/* Right: Profile Image */}
        <aside className="flex-1 flex justify-center md:justify-end">
          <figure className="bg-card rounded-2xl overflow-hidden shadow-lg w-80 h-96 flex items-center justify-center">
            <Image 
              src="/about.webp" 
              alt="Basant Kumar - Full Stack Developer working on modern web applications" 
              width={320} 
              height={384} 
